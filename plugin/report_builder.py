...
class ReportBuilder(FieldDataCaptureProject):
    ...
    def create_pdf_field_report(self) -> bool:
        ...
        try:
            ...
            story.append(Paragraph('Text in first sub heading', PS('body', leftIndent=10)))
            story.append(PageBreak())
            story.append(Paragraph('Second sub heading', h2))
            story.append(Paragraph('Text in second sub heading', PS('body', leftIndent=10)))
            story.append(Paragraph('Last heading', h1))

            doc = MyDocTemplate(str(self.pdf_report_file))
