<qgis styleCategories="Symbology|Labeling|Fields|Forms|MapTips" version="3.36.2-Maidenhead">
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="'../.field_data_capture/icons/BGS-placeholder.png'" field="photo_file"></default>
