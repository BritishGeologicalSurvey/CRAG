...
<qgis styleCategories="Symbology|Labeling|Fields|Forms|MapTips" version="3.44.10-Solothurn">
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="if( @qgis_platform IS 'desktop', '../_crag/icons/BGS-placeholder.png', NULL )" field="photo_file"></default>
