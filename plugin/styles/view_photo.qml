<qgis labelsEnabled="0" styleCategories="Symbology|Labeling|Fields|Forms|MapTips" version="3.40.7-Bratislava">
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="marker">
        ...
        <layer class="SvgMarker" enabled="1" id="{da8def63-c632-4c75-9954-49fd3568c1d9}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="name" type="QString" value="base64:"></Option>
            ...
            <Option name="outline_color" type="QString" value="34,34,34,255,rgb:0.13333333333333333,0.13333333333333333,0.13333333333333333,1"></Option>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{cb44ac43-88ba-4617-b51b-390c008922eb}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"></Option>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="photo_uuid">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="photo_file" index="7" name=""></alias>
    <alias field="caption" index="8" name=""></alias>
    <alias field="photo_uuid" index="9" name=""></alias>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets></widgets>
  <mapTip enabled="1">&lt;span style="font-weight:bolder;"&gt;[%"caption"%]&lt;/span&gt;&lt;br /&gt;&#xD;
&lt;img src='file:///[%@project_folder%]/photos/[%photo_file%]' width='250'&gt;&#xD;
</mapTip>
