...
<qgis labelsEnabled="0" styleCategories="Symbology|Labeling|Fields|Forms|MapTips" version="3.40.7-Bratislava">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{a5419f4d-76cb-43b9-850e-d32baa9bda51}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"></Option>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="media_type">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="media_uuid">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="media_type" index="7" name=""></alias>
    <alias field="media_link" index="8" name=""></alias>
    <alias field="media_description" index="9" name=""></alias>
    <alias field="media_uuid" index="10" name=""></alias>
