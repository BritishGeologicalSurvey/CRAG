...
<qgis styleCategories="Symbology|Labeling|Fields|Forms|MapTips" version="3.44.10-Solothurn">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReadOnly" type="bool" value="false"></Option>
            <Option name="ReferencedLayerDataSource" type="invalid"></Option>
            <Option name="ReferencedLayerId" type="QString" value="dic_structure_b706ba08_2dc2_4c2f_aa55_efb93612487d"></Option>
  ...
  <constraints>
    ...
    <constraint constraints="5" exp_strength="1" field="structure_type_code" notnull_strength="1" unique_strength="0"></constraint>
    ...
    <constraint constraints="4" exp_strength="1" field="secondary_attribute" notnull_strength="0" unique_strength="0"></constraint>
    <constraint constraints="4" exp_strength="1" field="third_attribute" notnull_strength="0" unique_strength="0"></constraint>
  ...
  <constraintExpressions>
    ...
    <constraint desc="Character limit: 255" exp="if(&quot;third_attribute&quot; is not null, length(&quot;third_attribute&quot;) &lt;= 255, true)" field="third_attribute"></constraint>
