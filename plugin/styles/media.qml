...
<qgis styleCategories="Symbology|Labeling|Fields|Forms|MapTips" version="3.44.10-Solothurn">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReadOnly" type="bool" value="false"></Option>
            <Option name="ReferencedLayerDataSource" type="invalid"></Option>
            <Option name="ReferencedLayerId" type="QString" value="dic_media_10553751_0996_4b92_b132_8d9bd294b4c4"></Option>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="if( @qgis_platform IS 'desktop', '../_crag/icons/BGS-placeholder.png', NULL )" field="media_link"></default>
  ...
  <constraints>
    ...
    <constraint constraints="5" exp_strength="1" field="media_type_code" notnull_strength="1" unique_strength="0"></constraint>
    <constraint constraints="4" exp_strength="1" field="media_link" notnull_strength="0" unique_strength="0"></constraint>
    <constraint constraints="4" exp_strength="2" field="media_description" notnull_strength="0" unique_strength="0"></constraint>
  ...
  <constraintExpressions>
    ...
    <constraint desc="Character limit: 50" exp="if(&quot;media_type_code&quot; is not null, length(&quot;media_type_code&quot;) &lt;= 50, true)" field="media_type_code"></constraint>
    <constraint desc="Media link must be in the project folder and has a character limit of 4000" exp="if(&quot;media_link&quot; is not null, length(&quot;media_link&quot;) &lt;= 4000, true)&#xD;&#xA;and&#xD;&#xA;(&#xD;&#xA;&#x9;-- Media is the placeholder image&#xD;&#xA;&#x9;&quot;media_link&quot;='../_crag/icons/BGS-placeholder.png'&#xD;&#xA;&#x9;or&#xD;&#xA;&#x9;(&#xD;&#xA;&#x9;&#x9;-- Media must be within project media folder&#xD;&#xA;&#xD;&#xA;&#x9;&#x9;-- Don't match absolute windows paths (e.g. starting with &quot;C:/&quot;)&#xD;&#xA;&#x9;&#x9;not(regexp_match(lower(&quot;media_link&quot;), '^[a-z]:/'))&#xD;&#xA;&#x9;&#x9;and&#xD;&#xA;&#x9;&#x9;-- Don't match absolute Linux paths (starting with &quot;/&quot;)&#xD;&#xA;&#x9;&#x9;not(regexp_match(&quot;media_link&quot;, '^/'))&#xD;&#xA;&#x9;&#x9;and&#xD;&#xA;&#x9;&#x9;-- Don't match filepaths from parent directories (e.g. starting with &quot;../&quot;)&#xD;&#xA;&#x9;&#x9;not(regexp_match(&quot;media_link&quot;, '^\\.\\./'))&#xD;&#xA;&#x9;&#x9;and&#xD;&#xA;&#x9;&#x9;-- Don't match files in the unlinked directory&#xD;&#xA;&#x9;&#x9;not(regexp_match(lower(&quot;media_link&quot;), '^unlinked'))&#xD;&#xA;&#x9;)&#xD;&#xA;)" field="media_link"></constraint>
    <constraint desc="Character limit: 4000" exp="if(&quot;media_description&quot; is not null, length(&quot;media_description&quot;) &lt;= 4000, true)" field="media_description"></constraint>
