...
<qgis version="3.30.0-'s-Hertogenbosch" styleCategories="Symbology|Labeling|Fields|Forms">
  ...
  <aliases>
    ...
    <alias field="media_type_code" name="" index="4"/>
    <alias field="media_link" name="" index="5"/>
    <alias field="comment" name="" index="6"/>
    <alias field="user_entered" name="" index="7"/>
    <alias field="date_entered" name="" index="8"/>
    <alias field="user_updated" name="" index="9"/>
    <alias field="date_updated" name="" index="10"/>
  </aliases>
  <splitPolicies>
  ...
  <defaults>
    ...
    <default field="media_type_code" applyOnUpdate="0" expression=""/>
    <default field="media_link" applyOnUpdate="0" expression=""/>
    <default field="comment" applyOnUpdate="0" expression="mallard"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="1" field="media_type_code" unique_strength="0" notnull_strength="1"/>
    <constraint exp_strength="0" constraints="1" field="media_link" unique_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="media_type_code" desc="" exp=""/>
    <constraint field="media_link" desc="" exp=""/>
