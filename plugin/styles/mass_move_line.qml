      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerId" type="QString" value="dic_line_type_mass_move_eb3245c6_dbfb_4987_89e2_e9375ae299e1"></Option>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorTextElement horizontalStretch="0" name="suggested attributes" showLabel="1" verticalStretch="0">
      <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont bold="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" underline="0"></labelFont>
      </labelStyle>[% attribute(get_feature('dic_line_type_mass_move', 'code', current_value('line_type_code') ), 'sec_attrib_list')&#xD;&#xD;&#xD;
