...
<qgis styleCategories="Symbology|Labeling|Fields|Forms|MapTips" version="3.44.10-Solothurn">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReadOnly" type="bool" value="false"></Option>
            <Option name="ReferencedLayerDataSource" type="invalid"></Option>
            <Option name="ReferencedLayerId" type="QString" value="dic_manmade_landform_4edd5cbf_fd28_4a10_83eb_6d24fcb67d74"></Option>
  ...
  <constraints>
    ...
    <constraint constraints="5" exp_strength="1" field="manmade_type_code" notnull_strength="1" unique_strength="0"></constraint>
  ...
  <constraintExpressions>
    ...
    <constraint desc="Character limit: 50" exp="if(&quot;manmade_type_code&quot; is not null, length(&quot;manmade_type_code&quot;) &lt;= 50, true)" field="manmade_type_code"></constraint>
