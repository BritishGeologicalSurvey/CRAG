      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="marker">
        ...
        <layer class="SvgMarker" enabled="1" id="{da8def63-c632-4c75-9954-49fd3568c1d9}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="outline_color" type="QString" value="34,34,34,255,rgb:0.1333333,0.1333333,0.1333333,1"></Option>
...
&#xD;
[%if(file_exists(@project_folder || '/_crag/_thumbnails/' ||  "photo_file"), &#xD;
&#xD;
'&lt;img src="file:///' || @project_folder || '/_crag/_thumbnails/' || photo_file || '" /&gt;',&#xD;
&#xD;
