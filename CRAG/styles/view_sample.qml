...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|Fields|Forms|MapTips" version="3.44.10-Solothurn">
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="marker">
        ...
        <layer class="SvgMarker" enabled="1" id="{eeb34cfd-d353-4584-aa7e-76df2cf4783f}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"></Option>
            <Option name="color" type="QString" value="2,1,0,255,rgb:0.0078431,0.0039216,0,1"></Option>
            <Option name="fixedAspectRatio" type="QString" value="0"></Option>
            <Option name="horizontal_anchor_point" type="QString" value="1"></Option>
            <Option name="name" type="QString" value="base64:"></Option>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{0da1f1df-4c2a-42a8-b977-7e51e77bf472}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"></Option>
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="markerSymbol" type="marker">
            ...
            <layer class="SimpleMarker" enabled="1" id="" locked="0" pass="0">
              <Option type="Map">
                <Option name="angle" type="QString" value="0"></Option>
                <Option name="cap_style" type="QString" value="square"></Option>
                <Option name="color" type="QString" value="164,113,88,255,rgb:0.6431373,0.4431373,0.345098,1"></Option>
                <Option name="horizontal_anchor_point" type="QString" value="1"></Option>
                <Option name="joinstyle" type="QString" value="bevel"></Option>
                <Option name="name" type="QString" value="circle"></Option>
                <Option name="offset" type="QString" value="0,0"></Option>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="sample_type">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="sample_uuid">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="locality_type" index="6" name=""></alias>
    <alias field="sample_id" index="7" name=""></alias>
    <alias field="sample_type" index="8" name=""></alias>
    <alias field="sample_description" index="9" name=""></alias>
    <alias field="sample_uuid" index="10" name=""></alias>
